...
function testGetWeb3ClientVersion() {
    ...
    match ethereumRes {
        ...
        EthereumError e => test:assertFail(msg = e.message);
    }
    test:assertNotEquals(result.result, " ", msg = "Failed to get version of Web3Client.");
}
...
function testGetWeb3Sha3() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to convert data into a SHA3 hash.");
}
...
function testGetNetVersion() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get current network id.");
}
...
function testGeNetPeerCount() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of peers currently
...
function testGetEthProtocolVersion() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get current ethereum protocol version.");
}
...
function testGetEthSyncing() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get an object with data about the sync status");
}
...
function testGetEthCoinbase() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the current coinbase address.");
}
...
function testGetEthHashrate() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of hashes per second
...
function testGetEthGasPrice() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the current price per gas in wei.");
}
...
function testGetEthAccounts() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get a list of addresses owned by client.");
}
...
function testGetEthBlockNumber() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of most recent block.");
}
...
function testGetEthBalance() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the balance of the account of given address.");
}
...
function testGetEthStorageAt() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the value from a storage
...
function testGetEthTransactionCount() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of transactions sent from an address.");
}
...
function testGetEthBlockTransactionCountByHash() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of transactions in a block
...
function testGetEthUncleCountByBlockHash() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of uncles in a block from a block
...
function testGetEthUncleCountByBlockNumber() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the number of uncles in a block from
...
function testGetEthCode() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get code at a given address.");
}
...
function testGetEthSign() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to calculate an Ethereum specific signature");
}
...
function testSendEthTransaction() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to create new message call transaction or
...
function testSendEthRawTransaction() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to creates new message call transaction or
...
function testGetEthCall() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to executes a new message call immediately without creating
...
function testGetEthEstimateGas() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to generates and get an estimate of how much gas
...
function testGetEthBlockByHash() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get information about a block by hash.");
}
...
function testGetEthBlockByNumber() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get information about a block by block number");
}
...
function testGetEthTransactionByHash() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to the information about a transaction requested by
    transaction hash.");
}
...
function testGetEthTransactionByBlockHashAndIndex() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the information about a transaction by block hash and
...
function testGetEthTransactionByBlockNumberAndIndex() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get information about a transaction by block number
...
function testGetEthTransactionReceipt() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get the receipt of a transaction by transaction hash.");
}
...
function testGetEthUncleByBlockHashAndIndex() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get information about a uncle of a block by
...
function testGetEthUncleByBlockNumberAndIndex() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get information about a uncle of a block by number
...
function testEthNewFilter() {
    ...
    testFilterID = result.result;
    test:assertNotEquals(result.result, " ", msg = "Failed to creates a filter object, based on filter options,
...
function testEthNewBlockFilter() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to creates a filter in the node,
...
function testUninstallEthFilter() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to uninstalls a filter with given id.");
}
...
function testGetEthFilterLogs() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get an array of all logs matching filter with given id.");
}
...
function testGetEthFilterChanges() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to returns an array of logs which occurred
    since last poll.");
}
...
function testGetEthLogs() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to get an array of all logs matching
    a given filter object.");
}

@test:Config
function testGetEthWork() {
    io:println("Test case for get the hash of the current block, the seedHash, and the boundary condition to be
    met (\"target\").");
    Result result;
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to the hash of the current block, the seedHash,
...
function testSubmitEthWork() {
    ...
    test:assertNotEquals(result.result, " ", msg = "Failed to submitting a proof-of-work solution.");
}
