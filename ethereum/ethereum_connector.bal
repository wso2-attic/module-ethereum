...
# + ethereumClient - The HTTP Client
public type EthereumConnector client object {

    public string jsonRpcVersion;
    public string networkId;
    public string jsonRpcEndpoint;
    public http:Client ethereumClient;

    public function __init(string url, EthereumConfiguration ethereumConfig) {
        self.ethereumClient = new(url, config = ethereumConfig.clientConfig);
        self.jsonRpcVersion = ethereumConfig.jsonRpcVersion;
        self.jsonRpcEndpoint = ethereumConfig.jsonRpcEndpoint;
        self.networkId = ethereumConfig.networkId;
    }
...
remote function EthereumConnector.getWeb3ClientVersion() returns string|error {
   
    var httpResponse = self.ethereumClient -> post("/", constructRequest(self.jsonRpcVersion, check int.create(self.networkId),
...
remote function EthereumConnector.getWeb3Sha3(string data) returns string|error {
...
remote function EthereumConnector.getNetVersion() returns string|error {
...
remote function EthereumConnector.getNetPeerCount() returns string|error {
...
remote function EthereumConnector.getNetListening() returns boolean|error {
...
remote function EthereumConnector.getEthProtocolVersion() returns string|error {
...
remote function EthereumConnector.getEthSyncing() returns string|error {
...
remote function EthereumConnector.getEthCoinbase() returns string|error {
...
remote function EthereumConnector.getEthMining() returns boolean|error {
...
remote function EthereumConnector.getEthHashrate() returns string|error {
...
remote function EthereumConnector.getEthGasPrice() returns string|error {
...
remote function EthereumConnector.getEthAccounts() returns string|error {
...
remote function EthereumConnector.getEthBlockNumber() returns string|error {
...
remote function EthereumConnector.getEthBalance(string address, string block) returns string|error {
...
remote function EthereumConnector.getEthStorageAt( string address, string position, string block)
...
remote function EthereumConnector.getEthTransactionCount(string address, string block) returns string|error {
...
remote function EthereumConnector.getEthBlockTransactionCountByHash(string blockHash) returns string|error {
...
remote function EthereumConnector.getEthBlockTransactionCountByNumber(string block) returns string|error {
...
remote function EthereumConnector.getEthUncleCountByBlockHash(string blockHash) returns string|error {
...
remote function EthereumConnector.getEthUncleCountByBlockNumber(string block) returns string|error {
...
remote function EthereumConnector.getEthCode(string address, string block) returns string|error {
...
remote function EthereumConnector.getEthSign(string address, string message) returns string|error {
...
remote function EthereumConnector.sendEthTransaction(json transactionObject) returns string|error {
...
remote function EthereumConnector.sendEthRawTransaction(string signedTransactionData) returns string|error {
...
remote function EthereumConnector.getEthCall(json transactionCallObject, string block) returns string|error {
...
remote function EthereumConnector.getEthEstimateGas(json transactionCallObject) returns string|error {
...
remote function EthereumConnector.getEthBlockByHash(string blockHash, boolean transactionObjectStatus)
                                returns string|error {
...
remote function EthereumConnector.getEthBlockByNumber(string block, boolean transactionObjectStatus)
                                returns string|error {
...
remote function EthereumConnector.getEthTransactionByHash(string transactionHash) returns string|error {
...
remote function EthereumConnector.getEthTransactionByBlockHashAndIndex(string blockHash, string  position)
                                returns string|error {
...
remote function EthereumConnector.getEthTransactionByBlockNumberAndIndex(string block, string  position)
                                returns string|error {
...
remote function EthereumConnector.getEthTransactionReceipt(string transactionHash) returns string|error {
...
remote function EthereumConnector.getEthUncleByBlockHashAndIndex(string blockHash, string position)
                                returns string|error {
...
remote function EthereumConnector.getEthUncleByBlockNumberAndIndex(string block, string position)
                                returns string|error {
...
remote function EthereumConnector.ethNewFilter(json filterOptions) returns string|error {
...
remote function EthereumConnector.ethNewBlockFilter() returns string|error {
...
remote function EthereumConnector.ethNewPendingTransactionFilter() returns string|error {
...
remote function EthereumConnector.uninstallEthFilter(string filterId) returns string|error {
...
remote function EthereumConnector.getEthFilterChanges(string filterId) returns string|error {
...
remote function EthereumConnector.getEthFilterLogs(string filterId) returns string|error {
...
remote function EthereumConnector.getEthLogs(json filterOptions) returns string|error {
...
remote function EthereumConnector.getEthWork() returns string|error {
...
remote function EthereumConnector.submitEthWork(string nonce, string powHash, string mixDigest) returns string|error {
...
remote function EthereumConnector.remoteProcedureCall(string method, json params) returns string|error {
