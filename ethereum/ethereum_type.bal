...
public type EthereumConnector object {
    ...
    #
    # + return - If success, return result, else returns EthereumError
    public function getWeb3ClientVersion() returns Result|EthereumError;

    # Get SHA3 result of the given string.
    #
    # data - The data to convert into a SHA3 hash
    # + return - If success, return result, else returns EthereumError
    public function getWeb3Sha3(string data) returns Result|EthereumError;
    ...
    #
    # + return - If success, return result, else returns EthereumError
    public function getNetVersion() returns Result|EthereumError;

    # Get the stauts for client is actively listening for network connections.
    #
    # + return - If success, return result, else returns EthereumError
    public function getNetListening() returns boolean|EthereumError;

    # Get the number of peers currently connected to the client.
    #
    # + return- If success, return result, else returns EthereumError
    public function getNetPeerCount() returns Result|EthereumError;

    # Get the current ethereum protocol version.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthProtocolVersion() returns Result|EthereumError;

    # Get an object with data about the sync status or false.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthSyncing() returns Result|EthereumError;

    # Get the client coinbase address.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthCoinbase() returns Result|EthereumError;

    # Get the status for client is actively mining new blocks.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthMining() returns boolean|EthereumError;

    # Get the number of hashes per second that the node is mining with.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthHashrate() returns Result|EthereumError;

    # Get the current price per gas in wei.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthGasPrice() returns Result|EthereumError;

    # Get a list of addresses owned by client.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthAccounts() returns Result|EthereumError;

    # Get the number of most recent block.
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthBlockNumber() returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthBalance(string address, string block) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthStorageAt(string address, string position, string block) returns Result|EthereumError;
    ...
    # +block - Integer block number, or the string "latest", "earliest" or "pending"
    # + return - If success, return result, else returns EthereumError
    public function getEthTransactionCount( string address, string block) returns Result|EthereumError;

    # Get the number of transactions in a block from a block matching the given block hash.
    #
    # + blockHash - The hash of a block
    # + return - If success, return result, else returns EthereumError
    public function getEthBlockTransactionCountByHash(string blockHash) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthBlockTransactionCountByNumber(string block) returns Result|EthereumError;

    # Get the number of uncles in a block from a block matching the given block hash.
    #
    # + blockHash - The hash of a block
    # + return - If success, return result, else returns EthereumError
    public function getEthUncleCountByBlockHash(string blockHash) returns Result|EthereumError;

    # Get the number of uncles in a block from a block matching the given block number.
    #
    # block - Integer of a block number, or the string "earliest", "latest" or "pending"
    # + return - If success, return result, else returns EthereumError
    public function getEthUncleCountByBlockNumber(string block) returns Result|EthereumError;
    ...
    # + block  - Integer of a block number, or the string "earliest", "latest" or "pending"
    # + return - If success, return result, else returns EthereumError
    public function getEthCode(string address, string block) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthSign(string address, string message) returns Result|EthereumError;

    # Creates new message call transaction or a contract creation, if the data field contains code.
    #
    # + transactionObject - The transaction hash, or the zero hash if the transaction is not yet available
    # + return - If success, return result, else returns EthereumError
    public function sendEthTransaction(json transactionObject) returns Result|EthereumError;

    # Creates new message call transaction or a contract creation for signed transactions.
    # + signedTransactionData - the transaction hash, or the zero hash if the transaction is not yet available
    # + return - If success, return result, else returns EthereumError
    public function sendEthRawTransaction(string signedTransactionData) returns Result|EthereumError;
    ...
    # block - Integer of a block number, or the string "earliest", "latest" or "pending"
    # + return - If success, return result, else returns EthereumError
    public function getEthCall(json transactionCallObject, string block) returns Result|EthereumError;

    # Generates and returns an estimate of how much gas is necessary to allow the transaction to complete.
    #
    # + transactionCallObject - The transaction call object
    # + return - If success, return result, else returns EthereumError
    public function getEthEstimateGas(json transactionCallObject) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthBlockByHash(string blockHash, boolean transactionObjectStatus) returns Result|EthereumError;
    ...
    #                           of the transactions
    # + return - If success, return result, else returns EthereumError
    public function getEthBlockByNumber(string block, boolean transactionObjectStatus) returns Result|EthereumError;

    # Get the information about a transaction requested by transaction hash.
    #
    # + transactionHash - The hash of a transaction
    # + return - If success, return result, else returns EthereumError
    public function getEthTransactionByHash(string transactionHash) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthTransactionByBlockHashAndIndex(string blockHash, string position) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthTransactionByBlockNumberAndIndex(string block, string position) returns Result|EthereumError;

    # Get the receipt of a transaction by transaction hash.
    #
    # + transactionHash - The hash of a transaction
    # + return - If success, return result, else returns EthereumError
    public function getEthTransactionReceipt(string transactionHash) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function getEthUncleByBlockHashAndIndex(string blockHash, string position) returns Result|EthereumError;
    ...
    # + position - The uncle's index position
    # + return - If success, return result, else returns EthereumError
    public function getEthUncleByBlockNumberAndIndex(string block, string position) returns Result|EthereumError;

    # Creates a filter object, based on filter options, to notify when the state changes (logs).
    #
    # + filterOptions - The filter options
    # + return - If success, return result, else returns EthereumError
    public function ethNewFilter(json filterOptions) returns Result|EthereumError;

    # Creates a filter in the node, to notify when a new block arrives.
    #
    # + return - If success, return result, else returns EthereumError
    public function ethNewBlockFilter() returns Result|EthereumError;

    # Creates a filter in the node, to notify when new pending transactions arrive.
    #
    # + return - If success, return result, else returns EthereumError
    public function ethNewPendingTransactionFilter() returns Result|EthereumError;

    # Uninstalls a filter with given id.
    #
    # + filterId - The filter id
    # + return - If success, return result, else returns EthereumError
    public function uninstallEthFilter(string filterId) returns Result|EthereumError;

    # Get an array of logs which occurred since last poll.
    #
    # + filterId - The filter id
    # + return - If success, return result, else returns EthereumError
    public function getEthFilterChanges(string filterId) returns Result|EthereumError;

    # Get an array of all logs matching filter with given id.
    #
    # + filterId - The filter id
    # + return - If success, return result, else returns EthereumError
    public function getEthFilterLogs(string filterId) returns Result|EthereumError;

    # Get an array of all logs matching a given filter object.
    #
    # + filterOptions - The filter options
    # + return - If success, return result, else returns EthereumError
    public function getEthLogs(json filterOptions) returns Result|EthereumError;

    # Get the hash of the current block, the seedHash, and the boundary condition to be met ("target").
    #
    # + return - If success, return result, else returns EthereumError
    public function getEthWork() returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError
    public function submitEthWork(string nonce, string powHash, string mixDigest) returns Result|EthereumError;
    ...
    # + return - If success, return result, else returns EthereumError.
    public function remoteProcedureCall(string method, json params) returns Result|EthereumError;
};
...
public type EthereumError record {
    string message;
    error? cause;
    int statusCode;
};
...
#
# + result - The result of the ethererum operation.
